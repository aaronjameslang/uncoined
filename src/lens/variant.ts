 ...
 * @example get('20c52f0b-8e8f-4ed1-c5d4-bc34595a6ef0') // => 2
 * @static
 */
export function get(uuid: Uuid) {
 ...
 * @returns {string} uuid
 * @example
 * set(0, '20c52f0b-8e8f-4ed1-c5d4-bc34595a6ef0')
 *         // => '20c52f0b-8e8f-4ed1-45d4-bc34595a6ef0'
 * @example
 * set(1, '20c52f0b-8e8f-4ed1-c5d4-bc34595a6ef0')
 *         // => '20c52f0b-8e8f-4ed1-85d4-bc34595a6ef0'
 * @example
 * set(2, '9d6316aa-2106-11e8-b467-0ed5f89f718b')
 *         // => '9d6316aa-2106-11e8-d467-0ed5f89f718b'
 * @example
 * set(2, '9d6316aa-2106-11e8-a467-0ed5f89f718b')
 *         // => '9d6316aa-2106-11e8-c467-0ed5f89f718b'
 * @example
 * set(3, '9d6316aa-2106-11e8-b467-0ed5f89f718b')
 *         // => '9d6316aa-2106-11e8-f467-0ed5f89f718b'
 * @static
 */
export function set(variant: Variant, uuid: Uuid) {
  const hexDigit = uuid.charAt(19)
